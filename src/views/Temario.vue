...
export default {
  ...
  data() {
    return {
      lessons: [
        { title: "Lección 1", image: "/path/to/lesson1/image.jpg", description: "Abecedario", locked: false, component: 'Tema1' },
        { title: "Lección 2", image: "assets/Logo.jpg", description: "Presente", locked: true, component: 'Tema2' },
        { title: "Lección 3", image: "/path/to/lesson3/image.jpg", description: "Colores", locked: true, component: 'Tema3' },
        { title: "Lección 4", image: "/path/to/lesson4/image.jpg", description: "Números", locked: true, component: 'Tema4' },
        { title: "Lección 5", image: "/path/to/lesson5/image.jpg", description: "Frases", locked: true, component: 'Tema5' }
      ],
